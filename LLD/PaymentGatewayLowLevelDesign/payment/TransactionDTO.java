...
public class TransactionDTO {
    ...
    public TransactionDTO(int transactionId, TransactionStatus transactionStatus, double amount, int senderId, int receiverId, int creditInstrumentId, int debitInstrumentId) {
